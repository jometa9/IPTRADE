...
IPTRADE is trade copying software, provided **100% free of charge**.

**Local Product (IPTRADE Multi):**
- Runs on your computer (Windows or macOS)
- All trading data stays local
- Windows: MT4, MT5, and cTrader. macOS: cTrader.
...
We grant you a personal, non-exclusive, non-transferable, free-of-charge license to use the software.
...
IPTRADE Multi is provided free of charge. There are no subscriptions, no per-account fees, no trials, and no hidden costs.
...
**Violations may result in immediate termination of your license to use the software.**
...
**By You:** Stop using and uninstall the software at any time.

**By Us:** We may terminate your license immediately for:
...
The software is provided **"as is"** without warranty of any kind. Because IPTRADE is free, our aggregate liability for any claim arising from your use of the software is limited to the maximum extent permitted by law.

We are not responsible for trading losses, broker or prop firm actions, or any indirect, incidental, or consequential damages.
...
We may update these terms. Material changes will be communicated through the software or website. Continued use after changes means you accept them.
